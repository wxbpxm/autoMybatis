...
public class Method extends JavaElement {
    ...
    //added by wangxuebiao
    private List<FullyQualifiedJavaType> dependTypes;
    ...
    public String getDeclare() {
    	StringBuilder sb = new StringBuilder(this.getReturnType().toString() );
    	...
    	for(Parameter param : this.getParameters()) {
    		...
    		sb.append(param.getFormattedContent());
    		i++;
    	}
    	sb.append(")");
    	return sb.toString();
    ...
    public String getParamLstAsString() {
    	StringBuilder sb = new StringBuilder();
    	for(Parameter param : this.getParameters()) {
    		sb.append(param.getFormattedContent()).append(",");
    	}
    	return sb.toString();
    }

	public List<FullyQualifiedJavaType> getDependTypes() {
		return dependTypes;
	}

	public void setDependTypes(List<FullyQualifiedJavaType> dependTypes) {
		this.dependTypes = dependTypes;
	}
