    ...
    public List<GeneratedXmlFile> getGeneratedXmlFiles() {
        ...
        if (xmlMapperGenerator != null) {
            ...
            GeneratedXmlFile gxf = new GeneratedXmlFile(document,
                ...
                false);
            String tableName = xmlMapperGenerator.getIntrospectedTable().getTableConfiguration().getTableName();
            gxf.setTableName(tableName);
            gxf.setBaseColumns(xmlMapperGenerator.getIntrospectedTable().getBaseColumns());
