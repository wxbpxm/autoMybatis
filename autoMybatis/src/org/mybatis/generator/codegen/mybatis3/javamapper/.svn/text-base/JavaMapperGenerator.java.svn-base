...
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.SelectByExampleWithBLOBsForUpdateMethodGenerator;
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.SelectByExampleWithBLOBsMethodGenerator;
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.SelectByExampleWithoutBLOBsForUpdateMethodGenerator;
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.SelectByExampleWithoutBLOBsMethodGenerator;
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.SelectByPrimaryKeyForUpdateMethodGenerator;
...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        addSelectByExampleWithBLOBsForUpdateMethod(interfaze);
        addSelectByExampleWithoutBLOBsMethod(interfaze);
        addSelectByExampleWithoutBLOBsForUpdateMethod(interfaze);
        addSelectByPrimaryKeyMethod(interfaze);
        addSelectByPrimaryKeyMethodWithLock(interfaze);
    ...
    protected void addSelectByExampleWithBLOBsForUpdateMethod(Interface interfaze) {
    	if (introspectedTable.getRules().generateSelectByExampleWithBLOBs()) {
    		AbstractJavaMapperMethodGenerator methodGenerator = new SelectByExampleWithBLOBsForUpdateMethodGenerator();
    		initializeAndExecuteGenerator(methodGenerator, interfaze);
    	}
    }
    ...
    protected void addSelectByExampleWithoutBLOBsForUpdateMethod(Interface interfaze) {
    	if (introspectedTable.getRules().generateSelectByExampleWithoutBLOBs()) {
    		AbstractJavaMapperMethodGenerator methodGenerator = new SelectByExampleWithoutBLOBsForUpdateMethodGenerator();
    		initializeAndExecuteGenerator(methodGenerator, interfaze);
    	}
    }
    ...
    protected void addSelectByPrimaryKeyMethodWithLock(Interface interfaze) {
    	if (introspectedTable.getRules().generateSelectByPrimaryKey()) {
    		AbstractJavaMapperMethodGenerator methodGenerator = new SelectByPrimaryKeyForUpdateMethodGenerator();
    		initializeAndExecuteGenerator(methodGenerator, interfaze);
    	}
    }
