...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.SelectByExampleWithBLOBsForUpdateElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.SelectByExampleWithoutBLOBsElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.SelectByExampleWithoutBLOBsForUpdateElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.SelectByPrimaryKeyElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.SelectByPrimaryKeyForUpdateElementGenerator;
...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        progressCallback.startTask(getString(
                "Progress.12", table.toString())); //$NON-NLS-1$n
        ...
        addSelectByExampleWithBLOBsForUpdateElement(answer);
        addSelectByExampleWithoutBLOBsElement(answer);
        addSelectByExampleWithoutBLOBsElementForUpdate(answer);
        addSelectByPrimaryKeyElement(answer);
        addSelectByPrimaryKeyElementWithLock(answer);
    ...
    protected void addSelectByExampleWithoutBLOBsElementForUpdate(
    		XmlElement parentElement) {
    	if (introspectedTable.getRules().generateSelectByExampleWithoutBLOBs()) {
    		AbstractXmlElementGenerator elementGenerator = new SelectByExampleWithoutBLOBsForUpdateElementGenerator();
    		initializeAndExecuteGenerator(elementGenerator, parentElement);
    	}
    }
    ...
    protected void addSelectByExampleWithBLOBsForUpdateElement(XmlElement parentElement) {
    	if (introspectedTable.getRules().generateSelectByExampleWithBLOBs()) {
    		AbstractXmlElementGenerator elementGenerator = new SelectByExampleWithBLOBsForUpdateElementGenerator();
    		initializeAndExecuteGenerator(elementGenerator, parentElement);
    	}
    }
    ...
    protected void addSelectByPrimaryKeyElementWithLock(XmlElement parentElement) {
    	if (introspectedTable.getRules().generateSelectByPrimaryKey()) {
